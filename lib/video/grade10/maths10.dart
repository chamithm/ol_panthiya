...
class Maths10 extends StatefulWidget {
  String lan;
  Maths10(this.lan);
  @override
  _Maths10State createState() => _Maths10State();
}

class _Maths10State extends State<Maths10> {
  @override
...
class _Part1State extends State<Part1> {
  ...
  void initState(){
    if("lan".tr().toString() == "en"){
      collection = "maths10_e_part1";
    }
    else{
      collection = "maths10_s_part1";
    }
    getLink();
    super.initState();
  }
            ...
            return Padding(
              ...
              child: InkWell(
                onTap: (){
                  ...
                  Navigator.push(context, MaterialPageRoute(builder: (context) => VideoPage(videoLink[0]['L${index+1}'],'maths10part1.$index'.tr())));
                },
                  ...
                  child: Row(
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text('maths10part1.$index'.tr(),style: TextStyle(color: Colors.white,fontSize: 14.0),),
                      ),
                    ],
                  ),
                ),
...
class _Part2State extends State<Part2> {
  ...
  void initState(){
    if("lan".tr().toString() == "en"){
      collection = "maths10_e_part2";
    }
    else{
      collection = "maths10_s_part2";
    }
    getLink();
    super.initState();
  }
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context,index){
            return Padding(
              ...
              child: InkWell(
                onTap: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context) => VideoPage(videoLink[0]['L${index+1}'],'maths10part2.$index'.tr())));
                },
                child: SingleChildScrollView(
                  scrollDirection: Axis.horizontal,
                  child: Row(
                    children: [
                      ...
                      Padding(
                        padding: const EdgeInsets.only(left:8.0),
                        child: Text('maths10part2.$index'.tr(),style: TextStyle(color: Colors.white,fontSize: 14.0),),
                      ),
                    ],
                  ),
                ),
