...
class English11 extends StatefulWidget {
  @override
  _English11State createState() => _English11State();
}

class _English11State extends State<English11> {
  @override
      ...
      child: DefaultTabController(
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            elevation: 0.0,
            title: Text("English",style: TextStyle(color: Colors.blue[50],fontSize: 14.0),),
...
class _Part1State extends State<Part1> {
  ...
  color(int index){
    ...
    switch(count){
      ...
      break;
      case 4 : return Colors.blue[600];
      break;
      case 5 : return Colors.blue[500];
      break;
    }
  }
...
class _Part2State extends State<Part2> {
  ...
  var lessions = [
    ...
    {
      "name":"Best Use Of Time",
      "icon":"5",
      "color":Colors.blueGrey[300],
    },
    {
      "name":"A Moment Of Fun",
      "icon":"6",
      "color":Colors.blueGrey[200],
    },
    {
      "name":"A Simple Living",
      "icon":"7",
      "color":Colors.blueGrey[300],
    },
    {
  ...
  Future<List<DocumentSnapshot>> getAllLink() {
    // return Firestore.instance.collection('english11').getDocuments().then((snap){
    //   return snap.documents;
    // });
    return FirebaseFirestore.instance.collection('english11').get().then((snap){
      return snap.docs;
    });
  }
