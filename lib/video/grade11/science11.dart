...
class Science11 extends StatefulWidget {
  String lan;
  Science11(this.lan);
  @override
  _Science11State createState() => _Science11State();
}

class _Science11State extends State<Science11> {
      ...
      child: DefaultTabController(
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            elevation: 0.0,
            title: Text("S2".tr().toString(),style: TextStyle(color: Colors.white,fontSize: 14.0),),
...
class _BioState extends State<Bio> {
  ...
  void initState(){
    if("lan".tr().toString() == "en"){
      collection = "science11_e_bio";
    }
    else{
      collection = "science11_s_bio";
    }
    getLink();
    super.initState();
  }
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context,index){
            return Padding(
              ...
              child: InkWell(
                onTap: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context) => VideoPage(videoLink[0]['L${index+1}'],'science11Bio.$index'.tr())));
                },
                  ...
                  child: Row(
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text('science11Bio.$index'.tr(),style: TextStyle(color: Colors.white,fontSize: 14.0),),
                      ),
                    ],
                  ),
                ),
...
class _PhysicsState extends State<Physics> {
  ...
  void initState(){
    if("lan".tr().toString() == "en"){
      collection = "science11_e_phy";
    }
    else{
      collection = "science11_s_phy";
    }
    getLink();
    super.initState();
  }
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context,index){
            return Padding(
              ...
              child: InkWell(
                onTap: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context) => VideoPage(videoLink[0]['L${index+1}'],'science11phy.$index'.tr())));
                },
                child: SingleChildScrollView(
                  scrollDirection: Axis.horizontal,
                  child: Row(
                    children: [
                      ...
                      Padding(
                        padding: const EdgeInsets.only(left:8.0),
                        child: Text('science11phy.$index'.tr(),style: TextStyle(color: Colors.white,fontSize: 14.0),),
                      ),
                    ],
                  ),
                ),
...
class _ChemistryState extends State<Chemistry> {
  ...
  void initState(){
    if("lan".tr().toString() == "en"){
      collection = "science11_e_che";
    }
    else{
      collection = "science11_s_che";
    }
    getLink();
    super.initState();
  }
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context,index){
            return Padding(
              ...
              child: InkWell(
                onTap: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context) => VideoPage(videoLink[0]['L${index+1}'],'science11che.$index'.tr())));
                },
                child: SingleChildScrollView(
                  scrollDirection: Axis.horizontal,
                  child: Row(
                    children: [
                      ...
                      Padding(
                        padding: const EdgeInsets.only(left:8.0),
                        child: Text('science11che.$index'.tr(),style: TextStyle(color: Colors.white,fontSize: 14.0),),
                      ),
                    ],
                  ),
                ),
